    ...
    emailjs
      .send(
        ...
        'template_5g175sf',
        {
          ...
          to_email: "dhruvgupta.31dg@gmail.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:dhruvgupta.31dg@gmail.com" target="_blank" className="blue-text-gradient">dhruvgupta.31dg@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://w.app/zVqv3T" target="_blank" className="blue-text-gradient">
              +44 7384849529
            </a>
          </article>
        </div>
